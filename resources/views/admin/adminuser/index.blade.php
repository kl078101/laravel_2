...
<table class="table table-bordered table-dark">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a onclick='return confirm("确认切换吗？")' href="{{route('admin.adminuser.state',[$adminusers->id])}}">{!!$adminusers->StateText!!}</a>
            </td>
            <td>{{$adminusers->created_at}}</td>
            <td>
                <a href="{{route('admin.adminuser.add',[$adminusers->id])}}"><button type="button" class="btn btn-primary btn-sm">编辑</button></a>
